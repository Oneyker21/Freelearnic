...
const RegisterClient = () => {
  ...
  const [idNumber, setIdNumber] = useState(''); // Estado para el número de ID
...
const handleIdNumberChange = (text) => {
  ...
  const registrarUsuario = async () => {
    ...
    try {
      ...
      const idClient = `clientId${user.uid}`;
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
          ...
          <View style={styles.containerView}>
            <View style={styles.login}>
              ...
              <CustomTextInput onChangeText={setUsername} value={username} placeholder="Nombre de usuario" />
              ...
              <ImagePickerButton onPress={() => pickImage(setIdFrontPhoto)} iconName="id-card-o" buttonText="Cédula (Frente)" />
              <PreviewImage uri={idFrontPhoto} />
              <ImagePickerButton onPress={() => pickImage(setIdBackPhoto)} iconName="id-card-o" buttonText="Cédula (Reverso)" />
